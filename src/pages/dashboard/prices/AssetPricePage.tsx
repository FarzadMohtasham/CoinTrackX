        ...
        <ErrorContainer $hasError={hasError}>
          <ErrorWrapper>
            ...
            <span className={'error-message'}>
              There was an error while fetching asset data from the server,
              Please refetch or contact with the admin.
            </span>
            <Button
              onClickHandler={() => setRefetchListener(refetchListener + 1)}
            >
              Try again
            </Button>
          </ErrorWrapper>
