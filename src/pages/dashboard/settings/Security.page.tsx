        ...
        <div className="step2-auth-options-wrapper">
          <div className={'step2-auth-option text-message'}>
            ...
            <div className={'desc-wrapper'}>
              ...
              <span className={'desc'}>
                When you sign in, you will receive OTP code to approve your
                login to your number <em>(+44) 5673 436 4xxx</em>
              </span>
            </div>
            <Switch
              size="md"
          ...
          <div className={'step2-auth-option email'}>
            ...
            <div className={'desc-wrapper'}>
              ...
              <span className={'desc'}>
                When you sign in, you will receive notification to approve your
                login on your email <em>andresamosa@mail.com</em>
              </span>
            </div>
            <Switch
              size="md"
