...
export default function CreditDebitCard(props: CreditDebitCardProps) {
  const { creditDebitCardInfo, onCardEditClickHandler } = props;
    ...
    <CreditDebitCardContainer>
      <div className="top-section">
        ...
        <div className="right-col">
          ...
          {typeof onCardEditClickHandler === 'function' && (
            <Icon
              iconSrc={'edit.svg'}
              width={'20px'}
              height={'20px'}
              className={'edit-icon'}
              onClickHandler={onCardEditClickHandler}
            />
          )}
        </div>
      </div>
