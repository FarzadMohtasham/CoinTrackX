...
import { PaymentMethodOptionProps } from '@Typings/PaymentMethodOption.type';
...
export default function PaymentMethodOptionComponent(
   props: PaymentMethodOptionProps,
) {
